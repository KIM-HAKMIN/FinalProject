...
public class FileManager { 
	...
	public String doFileUpload(byte[] bytes, String originalFilename, String path) throws Exception {
		...
		if(bytes == null)  // 내용물이 없으면 
			return null;   // 끝내기
		
		// 클라이언트가 업로드한 파일의 이름
		if(originalFilename.equals(""))  // 파일명이 없으면 
			return null;                 // 끝내기
		
		// 확장자												      // lastIndexOf 맨마지막에나오는 .  ==> 예 : 강.아.지.png 이면 png . 
