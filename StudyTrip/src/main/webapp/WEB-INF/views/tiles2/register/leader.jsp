	...
	$(document).ready(function() {
		...
		$("#submitBtn").click(function(){  
			...
			if(bool == false){
 			...
 			// 라디오버튼 선택 검사하기		
			var radioBool = $("input:radio[name=qualifi]").is(":checked"); 
			
			if(!radioBool) {  
				swal("리더 자격 충족 요건을 선택해주세요.");
...
<div class="container" align="center">
 ...
 <form class="form-horizontal" name="formhorizontal" enctype="multipart/form-data">
    ...
    <div class="form-group">
    	<label class="control-label col-sm-4">해당하는 리더 자격 충족 요건을 선택하세요<br/>(복수개일 경우 원하는 한가지만 선택하세요)</label>
